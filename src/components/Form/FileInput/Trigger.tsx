...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 bg-violet-25 px-6 py-4 text-center text-zinc-500 shadow-sm hover:bg-violet-25 hover:to-violet-500"
    >
